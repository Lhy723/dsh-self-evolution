...
import type { EvolutionPluginConfig, ResolvedEvolutionConfig } from './types.js'
...
export function resolveConfig(config: EvolutionPluginConfig = {}): ResolvedEvolutionConfig {
