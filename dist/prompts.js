...
export function targetTaskPrompt(benchmarkCase, profile, runIndex) {
    return [
        '<benchmark_task>',
...
export function evaluatorPersona() {
    return [
...
export function evaluatorPrompt(request) {
...
export function optimizerPersona() {
    return [
...
export function optimizerPrompt(request, config) {
    return [
